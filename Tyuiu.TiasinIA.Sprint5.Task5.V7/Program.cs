using System.IO;
using Tyuiu.TiasinIA.Sprint5.Task5.V7.Lib;
namespace Tyuiu.TiasinIA.Sprint5.Task5.V7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string path = Path.Combine(new string[] { Path.GetTempPath(), "InPutDataFileTask5V7.txt" });
